...
- `█` = saturated / canonical example
- `→` = produces, leads to, depends on
- `↻` = cycle, returns to start
- `═══▶` = strong / definitional flow
- `··· >` = optional / weak / dotted
- Single-line `┌─┐` for default structure
- Double-line `╔═╗` for emphasis (the headline element)
- Rounded `╭─╮` for soft, suggestive, less-rigid groupings

Use these consistently within one artifact. If you redefine `★` mid-piece, you've already lost the reader.
